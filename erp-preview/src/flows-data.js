export const FLOWS = [
  ...
  },
  {
    ...
    steps: [
      ...
      { screen: "W-17", label: "LR Console", role: "Godown Staff", desc: "Generate LR for dispatch" },
      { screen: "W-18", label: "LR Detail", role: "Godown Staff", desc: "Confirm dispatch, print LR" },
      { screen: "W-20", label: "Payment Records", role: "Accounts", desc: "Track and verify payments" },
